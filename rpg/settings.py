...
SECRET_KEY = 'a@wf!i*irkimbpq5brlhngem$of&pe@r4hh19r09k&lbs#atc='
...
USER, PASSWORD, HOST, PORT = open('rpg/credentials.txt').read().split()
...
AUTH_USER_MODEL = 'accounts.PlayerUser'
